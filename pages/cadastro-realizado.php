...
require_once 'includes/header.pages.php';?>
    <title>Stockash - Cadastro realizado</title>
...
<section class="register-success">
    <div>
        <h2 class="title">Cadastro <span class="title-color">realizado</span>!</h2>
        <p>Seu cadastro foi realizado com sucesso. Em breve nossa equipe de especialistas entrará em contato.</p>
        <a class="link" href="." title="Clique aqui para voltar à página principal">Voltar ao site</a>
    </div>
    </form>
</section>
